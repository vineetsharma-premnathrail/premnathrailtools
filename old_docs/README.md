...
| 8 | User Flow Document | ⚠️ | [ui-ux-design/USER_FLOWS.md](ui-ux-design/USER_FLOWS.md) — screen-level flows exist; no cross-journey document |
...
| 14 | API Documentation | ✅ | [application-programming-interface/](application-programming-interface/) (API.md + per-module) |
| 15 | UI/UX Design Specification | ✅ | [ui-ux-design/SCREEN_SPECIFICATIONS.md](ui-ux-design/SCREEN_SPECIFICATIONS.md) |
| 16 | Design System Documentation | ✅ | [ui-ux-design/DESIGN_SYSTEM.md](ui-ux-design/DESIGN_SYSTEM.md) |
...
| 44 | Decision Log / ADR | ✅ | [architecture-decision-records/](architecture-decision-records/) (0001–0003 + template) |
...
- **Per architectural decision**: add a new ADR under `architecture-decision-records/`.

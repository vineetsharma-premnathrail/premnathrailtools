...
// Legacy MOM (Minutes of Meeting) numbered-list textarea. No longer wired into
// ActivityForm — kept here in case the numbered-points workflow is reinstated.
  ...
  return (
    <div style={{ position: 'relative' }}>
      <button
        ...
        style={{ position: 'absolute', top: 6, right: 6, fontSize: 11, fontWeight: 600, padding: '2px 8px', borderRadius: 6, border: '1px solid rgba(0,0,0,0.1)', background: '#fff', color: '#78716c', cursor: 'pointer', zIndex: 1 }}
      >
        1.2.3.
      </button>
      <textarea
